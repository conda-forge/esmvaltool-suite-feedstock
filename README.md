...
Installing `esmvaltool` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating esmvaltool-feedstock
=============================

If you would like to improve the esmvaltool recipe or build a new
...
Note that all branches in the conda-forge/esmvaltool-feedstock are
